...
const DEFAULT_DATA={
  ...
  notifications:[],
  inventory:[],
  orderSettings:{nextNumber:1,statuses:["Yangi buyurtma","Loyiha tayyorlandi","Kesishga yuborildi","Kromka","Teshish","Yig‘ish","Sifat nazorati","Tayyor","Yetkazildi","Bekor qilindi"]},
  settings:{
    cutPrice:40000,
    edgePrice:0,
    drillPrice:0,

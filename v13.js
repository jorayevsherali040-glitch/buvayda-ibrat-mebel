...
function v21GlobalItems(){
  ...
  const services=[
    {id:"service-cut",name:"Laminat kesish",code:"KESISH",v21Type:"Xizmat",v21Price:0,imageUrl:(window.V21_HD_IMAGES?.laminate||"./service-laminate.jpg"),tags:["kesish","list","laminat"]},
    {id:"service-edge",name:"Kromka yopishtirish",code:"KROMKA",v21Type:"Xizmat",v21Price:0,imageUrl:(window.V21_HD_IMAGES?.edge||"./service-edge.jpg"),tags:["kromka","yopishtirish"]},
    {id:"service-drill",name:"Bazis teshish",code:"TESHISH",v21Type:"Xizmat",v21Price:0,imageUrl:(window.V21_HD_IMAGES?.drill||"./service-drill.jpg"),tags:["bazis","teshish","cnc"]},
    {id:"service-design",name:"3D dizayn",code:"DIZAYN",v21Type:"Xizmat",v21Price:0,imageUrl:(window.V21_HD_IMAGES?.design||"./service-design.jpg"),tags:["dizayn","loyiha"]}
  ];
